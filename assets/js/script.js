   //agrego la libreria Sweet alert, despues de instalarla con NPM.
 ...
 //actualizar carrito
  ...
  //cargo productos desde el productos.json
  let data = [];
  async function cargarDatos() {
    try {
      ...
      Swal.fire({
        title: '¡Error!',
        text: 'Falló la operación fetch',
        icon: 'error',
        confirmButtonText: 'Aceptar'
      });
    } finally {
      // Código a ejecutar independientemente de si ocurre un error o no. 
    }
  }
...
//busqueda por diferentes criterios
